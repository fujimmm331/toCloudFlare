import { A as reactive, d as defineComponent, Z as toRefs, $ as useRouter, k as watch, n as ref, m as useRoute, c as computed, a as createElementBlock, g as createCommentVNode, y as createBlock, e as unref, p as withCtx, f as createVNode, z as createTextVNode, I as Icon, V as watchEffect, o as openBlock, a0 as nextTick, h as defineStore, a1 as useResizeObserver, s as resolveComponent, a2 as renderSlot, b as createBaseVNode, M as h, a3 as onBeforeUnmount, X as mergeProps, T as Transition, q as normalizeClass, t as toDisplayString, a4 as i0, a5 as jm, a6 as Gm, a7 as Km, r as resolveDirective, w as withDirectives, a8 as withModifiers, Y as resolveDynamicComponent, F as Fragment, x as renderList, a9 as kt, aa as clone, ab as omit, j as useStorage, G as onMounted, ac as useTimeoutFn, ad as onClickOutside, ae as vModelText, v as withKeys, i as isRef, N as applyState, W as markRaw, af as shallowRef, ag as createHighlighter, ah as t0, ai as unindent, l as useCssVars, B as normalizeStyle, aj as onUnmounted, ak as createStaticVNode, al as Ot, u as useEventListener, am as toRaw } from "./vendor-BDCGgBjB.js";
import { u as useStoryStore } from "./story-ZrjDJGO1.js";
import { _ as _export_sfc, b as BaseSplitPane, u as useScrollOnActive, i as isMobile, B as BaseListItemLink, a as _sfc_main$A } from "./responsive-XrJr8tqd.js";
import { B as BaseEmpty } from "./BaseEmpty.vue-DzAh3nVJ.js";
import { h as histoireConfig, b as clientSupportPlugins, i as isDark, d as base } from "./mapping-B19cAtml.js";
import { t as toRawDeep, _ as _sfc_main$z, g as getContrastColor, S as SANDBOX_READY, E as EVENT_SEND, a as STATE_SYNC, P as PREVIEW_SETTINGS_SYNC } from "./state-CIOi-oS1.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        ...
        ((_d = (_c = __props.variant.state) == null ? void 0 : _c._hPropDefs) == null ? void 0 : _d.length) ? (openBlock(), createElementBlock("div", _hoisted_4$5, [
      ...
      return openBlock(), createBlock(_component_VDropdown, {
        ...
        default: withCtx(({ shown }) => [
          createBaseVNode("div", {
            ...
            _ctx.event.argument ? (openBlock(), createElementBlock("span", _hoisted_1$j, toDisplayString(formattedArgument.value), 1)) : createCommentVNode("", true)
          ], 2)
        ]),
        popper: withCtx(() => [
          createBaseVNode("div", _hoisted_2$9, [
            createBaseVNode("pre", _hoisted_3$8, toDisplayString(_ctx.event.argument), 1)
          ])
        ]),
        _: 1
      });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        !unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
          createVNode(_sfc_main$8, { variant: _ctx.variant }, null, 8, ["variant"]),
          !_ctx.variant.responsiveDisabled ? (openBlock(), createBlock(_sfc_main$9, { key: 0 })) : createCommentVNode("", true),
          createVNode(ToolbarBackground),
          createVNode(_sfc_main$f),
          createVNode(_sfc_main$d, {
            variant: _ctx.variant,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => {
      var _a;
      return {
        "41c4d268": (_a = variant.value) == null ? void 0 : _a.iconColor
      };
    });
    const storyStore = useStoryStore();
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => {
      var _a;
      return {
        "0f021d3c": (_a = variant.value) == null ? void 0 : _a.iconColor
      };
    });
    const storyStore = useStoryStore();
    const variant = computed(() => storyStore.currentVariant);
