const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/SearchPane.vue-B01kV3fw.js","assets/vendor-BDCGgBjB.js","assets/story-ZrjDJGO1.js","assets/mapping-B19cAtml.js","assets/BaseEmpty.vue-DzAh3nVJ.js","assets/responsive-XrJr8tqd.js"])))=>i.map(i=>d[i]);
import { u as useEventListener, i as isRef, d as defineComponent, c as computed, a as createElementBlock, o as openBlock, r as resolveDirective, b as createBaseVNode, e as unref, f as createVNode, w as withDirectives, g as createCommentVNode, I as Icon, h as defineStore, j as useStorage, k as watch, l as useCssVars, m as useRoute, n as ref, p as withCtx, q as normalizeClass, t as toDisplayString, s as resolveComponent, v as withKeys, F as Fragment, x as renderList, y as createBlock, z as createTextVNode, A as reactive, B as normalizeStyle, T as Transition, C as vShow, D as defineAsyncComponent, _ as __vitePreload, E as useTitle, G as onMounted, H as createApp, J as createPinia, K as Gt } from "./vendor-BDCGgBjB.js";
import { i as isDark, c as customLogos, h as histoireConfig, t as toggleDark, r as router, f as files, m as mapFile, _ as _sfc_main$c, a as tree } from "./mapping-B19cAtml.js";
import { u as useStoryStore } from "./story-ZrjDJGO1.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as _sfc_main$b, i as isMobile, b as BaseSplitPane } from "./responsive-XrJr8tqd.js";
...
const _hoisted_1$9 = { class: "histoire-app-header htw-px-4 htw-h-16 htw-flex htw-items-center htw-gap-2" };
const _hoisted_2$6 = { class: "htw-py-3 sm:htw-py-4 htw-flex-1 htw-h-full htw-flex htw-items-center htw-pr-2" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$9, [
        createBaseVNode("div", _hoisted_2$6, [
          createBaseVNode("a", {
            ...
            createVNode(_sfc_main$a, { class: "htw-max-w-full htw-max-h-full" })
          ], 8, _hoisted_3$5)
        ]),
...
const _hoisted_1$8 = { class: "bind-tree-margin htw-flex htw-items-center htw-gap-2 htw-pl-4 htw-min-w-0" };
const _hoisted_2$5 = { class: "htw-truncate" };
const _hoisted_3$4 = {
  key: 0,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => ({
      "10fa28ae": filePadding.value,
      "8aa08936": _ctx.story.iconColor
    }));
    const props = __props;
        ...
        createVNode(BaseListItemLink, {
          ...
          default: withCtx(({ active }) => [
            createBaseVNode("span", _hoisted_1$8, [
              ...
              createBaseVNode("span", _hoisted_2$5, toDisplayString(_ctx.story.title), 1)
            ]),
            !_ctx.story.docsOnly ? (openBlock(), createElementBlock("span", _hoisted_3$4, toDisplayString(_ctx.story.variants.length), 1)) : createCommentVNode("", true)
          ]),
          _: 1
        }, 8, ["to"])
      ], 512);
...
const StoryListItem = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-048885b7"]]);
const _hoisted_1$7 = {
  "data-test-id": "story-list-folder",
  class: "histoire-story-list-folder"
};
const _hoisted_2$4 = { class: "bind-tree-padding htw-flex htw-items-center htw-gap-2 htw-min-w-0" };
const _hoisted_3$3 = { class: "htw-flex htw-flex-none htw-items-center htw-opacity-30 [.histoire-story-list-folder-button:hover_&]:htw-opacity-100 htw-ml-4 htw-w-4 htw-h-4 htw-rounded-sm htw-border htw-border-gray-500/40" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createBaseVNode("div", {
          ...
          createBaseVNode("span", _hoisted_2$4, [
            ...
            createBaseVNode("span", _hoisted_4, toDisplayString(_ctx.folder.title), 1)
          ])
        ], 32),
...
const StoryListFolder = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-10840b73"]]);
const _hoisted_1$6 = {
  "data-test-id": "story-group",
  class: "histoire-story-group htw-my-2 first:htw-mt-0 last:htw-mb-0 htw-group"
};
const _hoisted_2$3 = { class: "htw-truncate" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        _ctx.group.title ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _cache[0] || (_cache[0] = createBaseVNode("div", { class: "htw-h-[1px] htw-bg-gray-500/10 htw-mx-6 htw-mb-2 group-first:htw-hidden" }, null, -1)),
          createBaseVNode("div", {
            role: "button",
            tabindex: "0",
            ...
            createBaseVNode("span", _hoisted_2$3, toDisplayString(_ctx.group.title), 1)
          ], 32)
        ], 64)) : createCommentVNode("", true),
        isFolderOpen.value ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
...
const _hoisted_1$5 = { class: "histoire-story-list htw-overflow-y-auto" };
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tree, (element) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            element.group ? (openBlock(), createBlock(_sfc_main$6, {
              key: 0,
              group: element,
              stories: _ctx.stories
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => {
      var _a;
      return {
        "a3f02f4e": (_a = story.value) == null ? void 0 : _a.iconColor
      };
    });
    const storyStore = useStoryStore();
            ...
            story.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(folders.value, (file, key) => {
                return openBlock(), createElementBlock(Fragment, { key }, [
                  ...
                  _cache[0] || (_cache[0] = createBaseVNode("span", { class: "htw-opacity-40" }, " / ", -1))
                ], 64);
              }), 128)),
              createBaseVNode("span", _hoisted_2$2, [
                ...
                createBaseVNode("span", _hoisted_3$1, toDisplayString(story.value.variants.length), 1)
              ])
...
const Breadcrumb = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d15ecb89"]]);
const _hoisted_1$3 = { class: "histoire-initial-loading htw-fixed htw-inset-0 htw-bg-white dark:htw-bg-gray-700 htw-flex htw-flex-col htw-gap-6 htw-items-center htw-justify-center" };
...
const _hoisted_1$2 = { class: "histoire-search-loading htw-flex htw-items-center htw-gap-4 htw-pl-6 htw-border htw-border-transparent focus-visible:htw-border-primary-500 htw-h-[51px] htw-opacity-30" };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const SearchPane = defineAsyncComponent({
      loader: () => __vitePreload(() => import("./SearchPane.vue-B01kV3fw.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0),
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createBaseVNode("div", {
          ...
          loadSearch.value ? (openBlock(), createBlock(_sfc_main$1, {
            key: 2,
        ...
        createVNode(Transition, { name: "__histoire-fade" }, {
          default: withCtx(() => [
            loading.value ? (openBlock(), createBlock(_sfc_main$3, { key: 0 })) : createCommentVNode("", true)
          ]),
          _: 1
        })
      ], 64);
